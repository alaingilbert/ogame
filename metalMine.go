...
func (b *metalMine) Production(universeSpeed int, productionRatio, globalRatio float64, plasmaTech, level int) int {
	...
	production := int((levelProduction * productionRatio * globalRatio) + basicIncome)
	return production
}
