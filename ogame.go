...
type OGame struct {
	...
	ResourcesBuildings   map[CelestialID]ResourcesBuildings
	DefensesInfos        map[CelestialID]DefensesInfos
	ShipsInfos           map[CelestialID]ShipsInfos
	Fleets               []Fleet
	Slots                Slots
	Universe             string
	Username             string
...
func (b *OGame) getResourcesBuildings(celestialID CelestialID) (ResourcesBuildings, error) {
	...
	resourceBuildings, error := ExtractResourcesBuildings(pageHTML)
	if error != nil {
		b.ResourcesBuildings[celestialID] = resourceBuildings
	}
	return resourceBuildings, error
}
...
func (b *OGame) getDefense(celestialID CelestialID) (DefensesInfos, error) {
	...
	defensesInfos, error := ExtractDefense(pageHTML)
	if error != nil {
		b.DefensesInfos[celestialID] = defensesInfos
	}
	return defensesInfos, error
}
...
func (b *OGame) getShips(celestialID CelestialID) (ShipsInfos, error) {
	...
	shipsInfos, error := ExtractShips(pageHTML)
	if error != nil {
		b.ShipsInfos[celestialID] = shipsInfos
	}
...
func (b *OGame) getFacilities(celestialID CelestialID) (Facilities, error) {
	...
	facilities, error := ExtractFacilities(pageHTML)
	if error != nil {
		b.Facilities[celestialID] = facilities
	}
