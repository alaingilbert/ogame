...
func TestMetalMine_IsAvailable(t *testing.T) {
	mm := newMetalMine()
	assert.True(t, mm.IsAvailable(PlanetType, ResourcesBuildings{}, LfBuildings{}, Facilities{}, Researches{}, 0, NoClass))
	assert.False(t, mm.IsAvailable(DebrisType, ResourcesBuildings{}, LfBuildings{}, Facilities{}, Researches{}, 0, NoClass))
	assert.False(t, mm.IsAvailable(MoonType, ResourcesBuildings{}, LfBuildings{}, Facilities{}, Researches{}, 0, NoClass))
}
