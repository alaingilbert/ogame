...
func TestLunarBase_IsAvailable(t *testing.T) {
	lb := newLunarBase()
	assert.False(t, lb.IsAvailable(PlanetType, ResourcesBuildings{}, LfBuildings{}, Facilities{}, Researches{}, 0, NoClass))
	assert.False(t, lb.IsAvailable(DebrisType, ResourcesBuildings{}, LfBuildings{}, Facilities{}, Researches{}, 0, NoClass))
	assert.True(t, lb.IsAvailable(MoonType, ResourcesBuildings{}, LfBuildings{}, Facilities{}, Researches{}, 0, NoClass))
}
