...
func newDeathstar() *deathstar {
	...
	s.RapidfireAgainst = map[ID]int{SmallCargoID: 250, LargeCargoID: 250, LightFighterID: 200,
	...
	s.Requirements = map[ID]int{ShipyardID: 12, GravitonTechnologyID: 1, HyperspaceDriveID: 7,
