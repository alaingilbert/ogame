...
func TestExtractPlanet_en(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33677371))
...
func TestExtractPlanet_fr(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33629512))
...
func TestExtractPlanet_de(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33630447))
...
func TestExtractPlanet_dk(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33627426))
...
func TestExtractPlanet_es(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33644981))
...
func TestExtractPlanet_br(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33633767))
	assert.Equal(t, "Planeta Principal", planet.Name())
	assert.Equal(t, int64(12800), planet.Diameter())
...
func TestExtractPlanet_it(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33634944))
...
func TestExtractPlanet_jp(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33620484))
...
func TestExtractPlanet_tw(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33626432))
...
func TestExtractPlanet_hr(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33627961))
...
func TestExtractPlanet_no(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33624646))
...
func TestExtractPlanet_ro(t *testing.T) {
	...
	planet, _ := NewExtractorV71().ExtractPlanet(pageHTMLBytes, PlanetID(33629199))
...
func TestExtractPlanet_sk(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33625241))
...
func TestExtractPlanet_si(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33625245))
	assert.Equal(t, "Glavni Planet", planet.Name())
	assert.Equal(t, int64(12800), planet.Diameter())
...
func TestExtractPlanet_hu(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33621505))
...
func TestExtractPlanet_fi(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33625483))
...
func TestExtractPlanet_ba(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33621433))
	assert.Equal(t, "Glavni Planet", planet.Name())
	assert.Equal(t, int64(12800), planet.Diameter())
...
func TestExtractPlanet_gr(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33629206))
...
func TestExtractPlanet_mx(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33624669))
	assert.Equal(t, "Planeta Principal", planet.Name())
	assert.Equal(t, int64(12800), planet.Diameter())
	assert.Equal(t, int64(33), planet.Temperature().Min)
...
func TestExtractPlanet_cz(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33622822))
...
func TestExtractPlanet_jp1(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33623513))
	assert.Equal(t, "ホームワールド", planet.Name())
	assert.Equal(t, int64(12800), planet.Diameter())
...
func TestExtractPlanet_pl(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33669699))
...
func TestExtractPlanet_tr(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33650421))
...
func TestExtractPlanet_pt(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33635398))
	assert.Equal(t, "Planeta Principal", planet.Name())
	assert.Equal(t, int64(12800), planet.Diameter())
	assert.Equal(t, int64(33), planet.Temperature().Min)
	assert.Equal(t, int64(73), planet.Temperature().Max)
...
func TestExtractPlanet_nl(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33624684))
...
func TestExtractPlanet_ar(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33629527))
	assert.Equal(t, "Planeta Principal", planet.Name())
	assert.Equal(t, int64(12800), planet.Diameter())
	assert.Equal(t, int64(37), planet.Temperature().Min)
	assert.Equal(t, int64(77), planet.Temperature().Max)
...
func TestExtractPlanet_ru(t *testing.T) {
	...
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(33629521))
...
func TestExtractPlanet_notExists(t *testing.T) {
	pageHTMLBytes, _ := ioutil.ReadFile("samples/unversioned/overview_queues.html")
	_, err := NewExtractorV6().ExtractPlanet(pageHTMLBytes, PlanetID(12345))
	assert.NotNil(t, err)
}

func TestExtractPlanetByCoord(t *testing.T) {
	pageHTMLBytes, _ := ioutil.ReadFile("samples/unversioned/overview_queues.html")
	planet, _ := NewExtractorV6().ExtractPlanet(pageHTMLBytes, Coordinate{1, 301, 8, PlanetType})
	assert.Equal(t, "C1", planet.Name())
	assert.Equal(t, int64(14615), planet.Diameter())
}
...
func TestExtractPlanetByCoord_notExists(t *testing.T) {
	pageHTMLBytes, _ := ioutil.ReadFile("samples/unversioned/overview_queues.html")
	_, err := NewExtractorV6().ExtractPlanet(pageHTMLBytes, Coordinate{1, 2, 3, PlanetType})
	assert.NotNil(t, err)
}
...
func TestExtractMoons(t *testing.T) {
	pageHTMLBytes, _ := ioutil.ReadFile("samples/unversioned/overview_with_moon.html")
	moons := NewExtractorV6().ExtractMoons(pageHTMLBytes)
...
func TestExtractMoon_exists(t *testing.T) {
	pageHTMLBytes, _ := ioutil.ReadFile("samples/unversioned/overview_with_moon.html")
	_, err := NewExtractorV6().ExtractMoon(pageHTMLBytes, MoonID(33741598))
	assert.Nil(t, err)
}

func TestExtractMoon_notExists(t *testing.T) {
	pageHTMLBytes, _ := ioutil.ReadFile("samples/unversioned/overview_with_moon.html")
	_, err := NewExtractorV6().ExtractMoon(pageHTMLBytes, MoonID(12345))
	assert.NotNil(t, err)
}

func TestExtractMoonByCoord_exists(t *testing.T) {
	pageHTMLBytes, _ := ioutil.ReadFile("samples/unversioned/overview_with_moon.html")
	_, err := NewExtractorV6().ExtractMoon(pageHTMLBytes, Coordinate{4, 116, 12, MoonType})
	assert.Nil(t, err)
}

func TestExtractMoonByCoord_notExists(t *testing.T) {
	pageHTMLBytes, _ := ioutil.ReadFile("samples/unversioned/overview_with_moon.html")
	_, err := NewExtractorV6().ExtractMoon(pageHTMLBytes, Coordinate{1, 2, 3, PlanetType})
	assert.NotNil(t, err)
}
...
func TestExtractPlanetsMoon(t *testing.T) {
	pageHTMLBytes, _ := ioutil.ReadFile("samples/unversioned/overview_with_moon.html")
	planets := NewExtractorV6().ExtractPlanets(pageHTMLBytes)
...
func TestExtractPlanetsV9(t *testing.T) {
	pageHTMLBytes, _ := ioutil.ReadFile("samples/v9.0.0/en/overview.html")
	planets := NewExtractorV8().ExtractPlanets(pageHTMLBytes)
...
func TestExtractPlanetsEsV902(t *testing.T) {
	...
	planets := NewExtractorV6().ExtractPlanets(pageHTMLBytes)
	assert.Equal(t, 1, len(planets))
	assert.Equal(t, PlanetID(33620383), planets[0].ID())
	assert.Equal(t, Coordinate{Galaxy: 1, System: 41, Position: 4, Type: PlanetType}, planets[0].Coordinate())
...
func TestExtractPlanetsTwV902(t *testing.T) {
	...
	planets := NewExtractorV6().ExtractPlanets(pageHTMLBytes)
	assert.Equal(t, 1, len(planets))
	assert.Equal(t, PlanetID(33620229), planets[0].ID())
	assert.Equal(t, Coordinate{Galaxy: 1, System: 10, Position: 6, Type: PlanetType}, planets[0].Coordinate())
